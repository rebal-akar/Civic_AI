...
Usage:
    ...
    python -m scripts.run_experiment --strategy asv --model gpt-4o \
        --articles-dir data/test/articles \
        --labels-path data/test/test-task2-TC.labels
"""
...
def main():
    ...
    parser.add_argument("--temperature", type=float, default=0.0,
                        help="Temperature for non-ASV strategies")
